...
import com.google.gwt.sample.convv.ConvV.shared.FieldVerifier;
 ...
 */
public class ConvV implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		final Button sendButton = new Button("Convertation");
		...
		dialogBox.setText("The result of processing server");
		...
		dialogVPanel.add(new HTML("<br><b>The result of processing server:</b>"));
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				if (! FieldVerifier.isValidName(textToServer)){
					errorLabel.setText("Please enter the correct values");
					return;
				}
